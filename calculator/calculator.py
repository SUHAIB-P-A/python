...
f = font.Font(size=20)
# buttons
button1 = Button(window, text="1", font=f, command=lambda: Button_click("1"))
button2 = Button(window, text="2", font=f, command=lambda: Button_click("2"))
button3 = Button(window, text="3", font=f, command=lambda: Button_click("3"))
button4 = Button(window, text="4", font=f, command=lambda: Button_click("4"))
button5 = Button(window, text="5", font=f, command=lambda: Button_click("5"))
button6 = Button(window, text="6", font=f, command=lambda: Button_click("6"))
button7 = Button(window, text="7", font=f, command=lambda: Button_click("7"))
button8 = Button(window, text="8", font=f, command=lambda: Button_click("8"))
button9 = Button(window, text="9", font=f, command=lambda: Button_click("9"))
button0 = Button(window, text="0", font=f, command=lambda: Button_click("0"))
buttonok = Button(window, text="=", font=f, command=lambda: Button_click("="))
buttondot = Button(window, text="C", font=f, command=lambda: Button_click("C"))
buttonplus = Button(window, text="+", font=f,
                    command=lambda: Button_click("+"))
buttonsub = Button(window, text="-", font=f, command=lambda: Button_click("-"))
buttondiv = Button(window, text="/", font=f, command=lambda: Button_click("/"))
buttonmul = Button(window, text="*", font=f, command=lambda: Button_click("*"))
